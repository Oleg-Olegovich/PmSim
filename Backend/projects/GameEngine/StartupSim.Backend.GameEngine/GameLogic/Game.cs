...
using StartupSim.Backend.GameEngine.Exceptions;
using StartupSim.Backend.GameEngine.GameLogic.GameMaps;
        ...
        private static IGameMap FindMap(int number)
        {
            try
            {
                var handler = Activator.CreateInstance(null,
                    "StartupSim.Backend.GameEngine.GameLogic.GameMaps.Map" + number);
