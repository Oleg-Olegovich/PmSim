...
using StartupSim.Backend.Gateway.Client.Api;
using StartupSim.Frontend.Domain.Interfaces;
using StartupSim.Backend.GameEngine.Enums;
using StartupSim.Backend.Gateway.Contracts.Account;
using StartupSim.Backend.Gateway.Contracts.Actions;
using StartupSim.Backend.Gateway.Contracts.Credentials;
using StartupSim.Backend.Gateway.Contracts.Game;
using StartupSim.Backend.Gateway.Contracts.Game.GameObjects.Others;
using StartupSim.Backend.Gateway.Contracts.Game.Status;

namespace StartupSim.Frontend.Domain
{
    public class StartupSimDomain : IStartupSimDomain
    {
        ...
        /// For single mode.
        /// </summary>
        public StartupSimDomain()
        {
            _gateway = new Backend.Gateway.Client.SingleModeApi.GatewayClient();
        }

        /// <summary>
        /// For multiplayer mode.
        /// </summary>
        public StartupSimDomain(IOptions<ClientOptions> options)
        {
            ...
            _gateway = new Backend.Gateway.Client.MultiplayerModeApi.GatewayClient(gatewayClientOptions);
        }
