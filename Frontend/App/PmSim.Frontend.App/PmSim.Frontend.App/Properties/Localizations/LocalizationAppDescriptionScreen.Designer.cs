...
namespace PmSim.Frontend.App.Properties.Localizations {
    ...
    public class LocalizationAppDescriptionScreen {
        ...
        ///            
        ///            Игровые сущности
        ///            • Сотрудник. Характеризуется уровнями навыков. Желаемая зарплата формируется в зависимости от них по формуле m * (sp + sm + sd + sma) / (4 * ms) + r; где m – максимальная зарплата (игровая константа); sp, sm, sd и sma – уровни навыков программирования, музыки, дизайна и менеджмента; ms – максимально возможный уровень навыка (игровая константа); r – псевдослучайное число в диапазоне [-1; 1]. Вероятнос [rest of string was truncated]&quot;;.
        /// </summary>
