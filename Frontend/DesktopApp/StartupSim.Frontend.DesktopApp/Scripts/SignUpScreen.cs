...
public class SignUpScreen : BaseScreen
{
    ...
    public override void _Ready()
    {
        ...
        _buttons[0].Connect("pressed", this, "SignUpButtonPressed");
        _buttons[1].Connect("pressed", this, "SignInButtonPressed");
        _buttons[2].Connect("pressed", this, "BackButtonPressed");
    }

    public override void UpdateText()
    {
        _label.Text = Core.LanguageProvider.SignUp;
        _lines[0].PlaceholderText = "Email";
        _lines[1].PlaceholderText = Core.LanguageProvider.Login;
        _lines[2].PlaceholderText = Core.LanguageProvider.Password;
        _lines[3].PlaceholderText = Core.LanguageProvider.RepeatPassword;
        // Spaces are a crutch so that the English "password" is displayed in full.
        _buttons[0].Text = "   " + Core.LanguageProvider.SignUp + "   ";
        _buttons[1].Text = "        " + Core.LanguageProvider.SignIn + "        ";
    ...
    public void SignUpButtonPressed()
    {
        ...
        Core.ChangeScreen(Screens.EmailConfirmation);
    }
}
